    ...
    <footer id="foot"> 
       ...
       <div class="list">
          ...
          <div class="item flexbox" @click="policy_url()">
           ...
           <div class="item last flexbox" @click="claim()">
                <div class="icon flexbox align-items">
                    <i class="iconfont">&#xe650;</i>
                </div>
           ...
           <a href="tel:400-678-6078">
                <div class="item last flexbox">
                    ...
                    <div class="right flex flexbox align-items">服务热线：<span> 400-678-6078</span></div>
                </div>
           </a>
